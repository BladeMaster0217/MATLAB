function [ channeldata_tmp,channel_signalBias ] = subtractSignalBias( channeldata )
%SUBTRACTSIGNALBIAS Summary of this function goes here
%   Detailed explanation goes here
channeldata_tmp = channeldata;
channel_signalBias = zeros(16,1);
signal_THD =50;
for ii_channel = 1:16
...
idx = find(n==max(n),1,'first');
channel_signalBias(ii_channel) = xbin(idx)+signal_THD;
